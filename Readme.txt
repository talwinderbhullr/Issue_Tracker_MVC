...
Update-Database -Context Issue_Tracker_IdentityContext



5. On the console execute the following command

Update-Database -Context Issue_Tracker_MVCDataContext



6. After migration is successful Run the project 

7 if you click on Issues/Assignees and etc (Except Home) this will redirect you to ASP .net identity login page login from the following credentials

User : admin@trackissues.com
Password: 1qaz2wsX@
